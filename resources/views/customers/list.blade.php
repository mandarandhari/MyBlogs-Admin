                            ...
                            @foreach($customers as $key => $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" data-url="{{ route('user_destroy', [$customer->id]) }}" class="btn btn-sm btn-danger delete-customer-btn" data-target="#deleteCustomerModal" data-toggle="modal">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            @else
