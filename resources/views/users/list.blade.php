                            ...
                            @foreach($users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" data-url="{{ route('user_destroy', [$user->id]) }}" class="btn btn-sm btn-danger delete-article-btn" data-target="#deleteArticleModal" data-toggle="modal">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            @else
